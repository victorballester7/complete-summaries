...
\begin{multicols}{2}[\section{Complex analysis and Fourier analysis}]
  ...
  \begin{theorem}[Cauchy's integral theorem]
    Let $U\subseteq\CC$ be an open and convex set, $f\in\mathcal{H}(U)$, $\gamma:[a,b]\rightarrow\CC$ be a closed $\mathcal{C}^1$-piecewise curve and $z_0\notin\gamma^*$. Then:
  ...
  \end{corollary}
  \begin{lemma}
    Let $U\subseteq\CC$ be an open, $(f_n)\in U\subseteq\CC$ be a sequence of functions, $f:D\rightarrow\CC$ such that $(f_n)$ converge uniformly to $f$ over compact sets in $D$, and $\gamma:[a,b]\rightarrow\CC$ be a closed $\mathcal{C}^1$-piecewise curve. Then:
  ...
  \end{corollary}
  \begin{corollary}[Cauchy's integral theorem for derivatives]
  ...
  \end{theorem}
  \begin{corollary}
    Let $f\in\mathcal{H}(\CC)$ such that $\Re(f(z))>0$ $\forall z\in\CC$. Then, $f$ is constant.
  \end{corollary}
  ...
  \begin{theorem}
    Let $U\subseteq\CC$ be an open convex set and $f\in\mathcal{H}(U)$. Then, the following statements are equivalent:
    \begin{enumerate}
      \item $f(z)=0$.
  ...
  \end{theorem}
  \begin{corollary}
    Let $U\subseteq\CC$ be an open convex set and $f\in\mathcal{H}(U)$ such that $f$ is not identically zero. Then, if $z_0\in U$ is a zero of $f$, $\exists m\in\NN$ and $g\in\mathcal{H}(U)$ such that $g(z_0)\ne 0$ and: $$f(z)={(z-z_0)}^{m}g(z)$$ The value of $m$ is called \emph{multiplicity} of $z_0$. In particular, the zeros of $f$ are isolated.
  \end{corollary}
  \begin{theorem}[Analytic contiuation]
    Let $U\subseteq\CC$ be an open convex set and $f,g\in\mathcal{H}(U)$ such that ${\{z\in U:f(z)-g(z)=0\}}'\cap U\ne\varnothing$. Then, $f(z)=g(z)$ $\forall z\in U$
  \end{theorem}
\end{multicols}
\end{document}