...
\begin{multicols}{2}[\section{Differential geometry}]
  ...
  \end{theorem}
  \begin{proposition}
    Let $S\subseteq\RR^3$ be an orientable surface and $\vf\alpha:I\rightarrow S$ be a parametrized curve of class $\mathcal{C}^\infty$. Then, $\vf\alpha$ is a geodesic in a convenient parametrization if and only if: $$\left[\frac{\text{D}\vf{\alpha}'}{\dd{t}}\right]=\lambda(t)\vf\alpha'(t)$$
  \end{proposition}
  ...
  \end{theorem}
  \begin{theorem}[Local Gau\ss-Bonnet theorem]\label{DG_local-GB}
