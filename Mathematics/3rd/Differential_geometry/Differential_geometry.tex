...
\begin{multicols}{2}[\section{Differential geometry}]
  ...
  \end{proposition}
  \begin{proposition}
    Let $\vf{A}\in\text{O}(3)$. Then, there exists an orthonormal basis $\mathcal{B}$ of $\RR^3$ such that $${[\id]_{\mathcal{B},\text{Can}(\RR^3)}}^{-1}\vf{A}[\id]_{\mathcal{B},\text{Can}(\RR^3)}=\begin{pmatrix}
        \pm 1 & 0                                              & 0 \\
