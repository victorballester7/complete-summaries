...
\begin{multicols}{2}[\section{Differential geometry}]
  ...
  \end{definition}
  \begin{corollary}
    Let $S\subset\RR^3$ be an oriented surface, $T\subseteq S$ be a triangle such that their edges are geodesics. Then, in the notation of \mcref{DG:local-GB} we have: $$\iint_{T}K\dd{S}=\sum_{i=0}^n\phi_i-\pi$$
