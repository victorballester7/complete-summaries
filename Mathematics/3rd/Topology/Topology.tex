...
\begin{multicols}{2}[\section{Topology}]
  ...
  \begin{definition}[Torus]
    We define the \emph{torus} $T^2\subset \RR^3$ of major radius $R$ and minor radius $r$ (see \mcref{TOP:torus}) as: $$T^2:=\left\{(x,y,z)\in\RR^3:{\left(\sqrt{x^2+y^2}-R\right)}^2+z^2=r^2\right\}$$
  \end{definition}
  \begin{center}
  ...
  \begin{proposition}\label{TOP:square-sim}
    ...
    \begin{enumerate}
      ...
      \item $(0,t)\sim(1,1-t)\ \forall t\in[0,1]$. In that case, $X\cong \mathcal{M}$, where $\mathcal{M}$ is the \emph{Möbius band} (see \mcref{TOP:moebius}).
      \item $(0,t)\sim(1,t)$ and $(s,0)\sim(1-s,1)$ $\forall s,t\in[0,1]$. In that case, $X\cong \mathcal{K}$, where $\mathcal{K}$ is the \emph{Klein bottle} (see \mcref{TOP:klein}).
    \end{enumerate}
    \begin{center}
      \begin{minipage}{\linewidth}
        \centering
        \includestandalone[mode=image|tex,width=\linewidth]{Images/square}
        \captionof{figure}{Representation of the quotient spaces $\quot{{[0,1]}^2}{\sim}$, where $\sim$ is the equivalence relation defined on \protect\mcref{TOP:square-sim}}
        \label{TOP:fig-MK}
      \end{minipage}
    \end{center}
  \end{proposition}
  ...
  \begin{proposition}\label{TOP:circle-sim}
    ...
    \begin{center}
      \begin{minipage}{\linewidth}
        ...
        \captionof{figure}{Representation of the quotient space $\quot{\S^2}{\sim}$ (left), where $\sim$ is the equivalence relation defined on \protect\mcref{TOP:proj-sim} and the quotient space $\quot{B^2}{\sim}$ (right), where $\sim$ is the equivalence relation defined on \protect\mcref{TOP:circle-sim}}
        \label{TOP:fig-PS}
      \end{minipage}
    \end{center}
  \end{proposition}
  ...
  \end{definition}
  \begin{theorem}[One-point compactification]\label{TOP:alex}
  ...
  \begin{proposition}
    ...
    \footnote{See \protect\mcref{TOP:fig-MK,TOP:fig-PS} for a better understanding.}:
    \begin{itemize}
      \item $\S^2$: $aa^{-1}=:1$
      \item $T^2$: $aba^{-1}b^{-1}$
