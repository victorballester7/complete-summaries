...
\begin{multicols}{2}[\section{Topology}]
  ...
  \begin{prop}
    ...
    \end{enumerate}
  \end{prop}
  \begin{prop}[Connected sum of surfaces]
  ...
  \begin{theorem}
    ...
    \end{itemize}
  \end{theorem}
  % falta revisar suma connexa
  % posar def de localment euclidia? I def equivalents de la tercera propietat de varietat? (document 21)
  % fet fins el document 21 (inclòs) menys el document 15.
\end{multicols}
\end{document}