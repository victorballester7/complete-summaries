...
\begin{tikzpicture}[decorated curves/.style={
  ...
  \begin{axis}[
    ...
    \addplot[thick,samples=100,black,domain=0:sqrt(\ymax),decorated separatrices]{x^2};
    \addplot[thick,samples=100,black,domain=0:sqrt(-\ymin),decorated separatrices]{-x^2};
    \addplot[thick,samples=100,black,domain=-sqrt(\ymax):0,decorated separatrices rev]{x^2};
    \addplot[thick,samples=100,black,domain=-sqrt(-\ymin):0,decorated separatrices rev]{-x^2};
    \def\N{60}
    \def\ell{(\xmax-\xmin)/\N}
