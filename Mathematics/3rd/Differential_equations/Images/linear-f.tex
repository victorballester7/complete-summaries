...
\begin{tikzpicture}[decorated curves/.style={
  ...
  \begin{axis}[
    ...
    \draw[black, thick,decorated separatrices rev] (0,\ymin) --(0,0);
    \draw[black, thick,decorated separatrices rev]  (0,\ymax) -- (0,0);
    \addplot[thick,samples=100,black,domain=0:\xmax,decorated separatrices]{x/3};
    \addplot[thick,samples=100,black,domain=\xmin:0,decorated separatrices rev]{x/3};
    \addplot[thick,samples=100,black,domain=\ymin/2:0,decorated separatrices rev]{2*x};
    \addplot[thick,samples=100,black,domain=0:\ymax/2,decorated separatrices]{2*x};
    \addplot[thick,samples=100,black,domain=0:-\ymin,decorated separatrices]{-x};
    \addplot[thick,samples=100,black,domain=-\ymax:0,decorated separatrices rev]{-x};
    \addplot[thick,samples=100,black,domain=-\ymax/3:0,decorated separatrices rev]{-3*x};
    \addplot[thick,samples=100,black,domain=0:-\ymin/3,decorated separatrices]{-3*x};
    \def\N{60}
    \def\ell{(\xmax-\xmin)/\N}
