...
\begin{tikzpicture}[every node/.style={scale=0.7}]
  ...
  \begin{axis}[
    ...
    \node[orange!95!black] at (1/4*\xmin-0.25,3/4*\ymax){Stable spiral};
    \node[orange!80] at (1/4*\xmax+0.25,3/4*\ymax){Unstable spiral};
    ...
    \node[anchor=south east,scale=0.5] at (\xmax,\ymin){*A star if $\vf{A}$ is diagonalizable and a degenerated node if not.};
  \end{axis}
\end{tikzpicture}
