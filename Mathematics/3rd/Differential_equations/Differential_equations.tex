...
\begin{multicols}{2}[\section{Differential equations}]
  ...
  \end{proposition}
  \begin{theorem}
    Let $U\subseteq \RR^{2}$ be an open set, $H:U\rightarrow\RR$ be the Hamiltonian of its Hamiltonian associated system and $\vf{p}\in\RR^2$ be a singular point. Then, $\vf{p}$ is either a saddle point or a center.
  \end{theorem}
  ...
  \begin{theorem}[Poincaré-Bendixson theorem]
    Let $U\subseteq \RR^n$ be an open set, $\vf{f}:U\rightarrow\RR^n$ be a vector field of class $\mathcal{C}^1$ and $\vf{p}\in\RR^n$ such that $\vf{\gamma}(\vf{p})^+$ is contained in a compact set. Suppose that $\vf{f}$ has a finite number of singular points. Then:
    \begin{enumerate}
