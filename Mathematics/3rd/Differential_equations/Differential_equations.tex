...
\begin{multicols}{2}[\section{Differential equations}]
  ...
  \begin{definition}
    ...
    \begin{equation}\label{DE_ivp_lambda}
      \left\{
      \begin{aligned}
         & \vectorfunction{x}'      =\vectorfunction{f}(t,\vectorfunction{x},\lambda) \\
         & \vectorfunction{x}(t_0)  =x_0
      \end{aligned}
      \right.
    \end{equation}
    has a unique maximal solution $\vectorfunction{\varphi}_{(t_0,x_0,\lambda)}(t)$ defined on an interval $I_{(t_0,x_0,\lambda)}$. We define the \textit{flux} of the ode $\vectorfunction{x}'=\vectorfunction{f}(t,\vectorfunction{x},\lambda)$ as: $$\function{\vectorfunction{\varphi}}{I_{(t_0,x_0,\lambda)}\times\RR\times\RR^n\times\RR^p}{\RR}{(t,t_0,x_0,\lambda)}{\vectorfunction{\varphi}_{(t_0,x_0,\lambda)}(t)}$$
  \end{definition}
  ...
  \end{lemma}
  \begin{prop}
    Let $U\subseteq\RR\times\RR^n$ be an open set and $\vectorfunction{f}:U\rightarrow\RR^n$ be a continuous function and Lipschitz continuous with respect to the second variable. Let $L$ be the Lipschitz constant. Then, $\forall (t_0,x_1),(t_0,x_2)\in U$ and $\forall t\in I_{(t_0,x_0)}$, we have:
    $$\|\vectorfunction{\varphi}(t,t_0,x_2)-\vectorfunction{\varphi}(t,t_0,x_1)\|\leq\exp{L|t-t_0|}\|x_2-x_1\|$$
  \end{prop}
  \subsubsection{Differenciable dependence}
  \begin{theorem}
    Let $U\subseteq\RR\times\RR^n\times\RR^p$ be an open set and $\vectorfunction{f}:U\rightarrow\RR^n$ be a continuous function and of class $\mathcal{C}^1$ with respect to the second variable. Suppose that the flux $\vectorfunction{\varphi}(t,t_0,x_0,\lambda)$ of $\vectorfunction{x}'=\vectorfunction{f}(t,\vectorfunction{x},\lambda)$ is defined on an open set $V\subseteq\RR\times\RR\times\RR^n\times\RR^p$. Then, $\forall (t,t_0,x,\lambda)\in V$, $\vectorfunction{\varphi}$ is differentiable with respect to $x_0$ and $\vectorfunction{D}_3\vectorfunction{\varphi}(t,t_0,x_0,\lambda)$\footnote{Here, $\vectorfunction{D}_3\vectorfunction{\varphi}(t,t_0,x_0,\lambda)=\frac{\partial\vectorfunction{\varphi}}{\partial x_0}(t,t_0,x_0,\lambda)$ denotes de matrix $\left(\frac{\partial\vectorfunction{\varphi}_i}{\partial{(x_0)}_j}(t,t_0,x_0,\lambda)\right)\in\mathcal{M}_n(\RR)$, where ${(x_0)}_j$ denotes the $j$-th component of $x_0$ and $\vectorfunction{\varphi}_i(t,t_0,x_0,\lambda)$ denotes the $i$-th component of $\vectorfunction{\varphi}(t,t_0,x_0,\lambda)$.} is continuous on $V$. Furthermore, $\vectorfunction{D}_3\vectorfunction{\varphi}(t,t_0,x_0,\lambda)$ satisfies the following ivp:
    \begin{equation*}
      \left\{
      \begin{aligned}
         & \vectorfunction{M}'      =\vectorfunction{D}_2\vectorfunction{f}(t,\vectorfunction{\varphi}(t,t_0,x_0,\lambda),\lambda)\vectorfunction{M} \\
         & \vectorfunction{M}(t_0)  =\vectorfunction{I}_n
      \end{aligned}
      \right.
    \end{equation*}
    or, equivalently, $\frac{\partial\vectorfunction{\varphi}}{\partial \lambda_i}(t,t_0,x_0,\lambda)=\vectorfunction{D}_3\vectorfunction{\varphi}(t,t_0,x_0,\lambda)\vectorfunction{e}_i$ satisfies the following ivp:
    $$
      \left\{
      \begin{aligned}
         & \vectorfunction{y}'      =\vectorfunction{D}_2\vectorfunction{f}(t,\vectorfunction{\varphi}(t,t_0,x_0,\lambda),\lambda)\vectorfunction{y} \\
         & \vectorfunction{y}(t_0)  =\vectorfunction{e}_i
      \end{aligned}
      \right.\quad\text{for }i=1,\ldots,n
    $$
    These equations are called \textit{variational equations}.
  \end{theorem}
  \begin{theorem}
    Let $U\subseteq\RR\times\RR^n\times\RR^p$ be an open set and $\vectorfunction{f}:U\rightarrow\RR^n$ be a continuous function and of class $\mathcal{C}^1$ with respect to the second and third variable. Suppose that the flux $\vectorfunction{\varphi}(t,t_0,x_0,\lambda)$ of $\vectorfunction{X}'=\vectorfunction{f}(t,\vectorfunction{x},\lambda)$ is defined on an open set $V\subseteq\RR\times\RR\times\RR^n\times\RR^p$. Then, $\forall (t,t_0,x,\lambda)\in V$, $\vectorfunction{\varphi}$ is differentiable with respect to $\lambda$ and $\vectorfunction{D}_4\vectorfunction{\varphi}(t,t_0,x_0,\lambda)$ is continuous on $V$. Furthermore, $\vectorfunction{D}_4\vectorfunction{\varphi}(t,t_0,x_0,\lambda)$ satisfies the following ivp:
    \begin{equation*}
      \left\{
      \begin{aligned}
         & \vectorfunction{M}'      =\vectorfunction{D}_2\vectorfunction{f}(t,\vectorfunction{\varphi}(t,t_0,x_0,\lambda),\lambda)\vectorfunction{M}+ \vectorfunction{B} \\
         & \vectorfunction{M}(t_0)  =\vectorfunction{0}
      \end{aligned}
      \right.
    \end{equation*}
    where $\vectorfunction{B}=\vectorfunction{D}_3\vectorfunction{f}(t,\vectorfunction{\varphi}(t,t_0,x_0,\lambda),\lambda)$. Equivalently, $\frac{\partial\vectorfunction{\varphi}}{\partial \lambda_i}(t,t_0,x_0,\lambda)$ satisfies the ivp:
    $$
      \left\{
      \begin{aligned}
         & \vectorfunction{y}'      =\vectorfunction{D}_2\vectorfunction{f}(t,\vectorfunction{\varphi}(t,t_0,x_0,\lambda),\lambda)\vectorfunction{y}+\vectorfunction{B}\vectorfunction{e}_i \\
  ...
  \begin{theorem}
    Let $U\subseteq\RR\times\RR^n$ be an open set and $\vectorfunction{f}:U\rightarrow\RR^n$ be a continuous function and of class $\mathcal{C}^k$, $k\in\NN$, with respect to the second variable. Suppose that the flux $\vectorfunction{\varphi}(t,t_0,x_0)$ of $\vectorfunction{x}'=\vectorfunction{f}(t,\vectorfunction{x})$ is defined on an open set $V\subseteq\RR\times\RR\times\RR^n$. Then, $\vectorfunction{\varphi}(t,t_0,x_0)$ is of class $\mathcal{C}^k$ on $V$.
  \end{theorem}
\end{multicols}
\end{document}