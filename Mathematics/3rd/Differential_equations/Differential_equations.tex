...
\begin{multicols}{2}[\section{Differential equations}]
  ...
  \end{definition}
  \begin{definition}
    Let $U,\tilde{U}\subseteq \RR^n$ be open sets with $\tilde{U}\subseteq U$, $\vf{f}:U\rightarrow\RR^n$ be a vector field of class $\mathcal{C}^1$ and $\vf{p}\in \tilde{U}$ be a critical point of $\vf{f}$. We say that a function $V:\tilde{U}\rightarrow\RR$ of class $\mathcal{C}^1$ is a \emph{Lyapunov function} for $\vf{p}$ if
    \begin{itemize}
