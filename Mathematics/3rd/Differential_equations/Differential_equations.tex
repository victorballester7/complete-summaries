...
\begin{multicols}{2}[\section{Differential equations}]
  ...
  \end{center}
  \begin{definition}
    Let $U\subseteq \RR^2$ be an open set, $\vf{f}:U\rightarrow\RR^2$ be a vector field of class $\mathcal{C}^1$ and $\vf{p}\in U$ be an critical point of $\vf{f}$. We say that $\vf{p}$ has an \emph{elliptic sector} if a side of $\vf{p}$ is locally as:
    We say that $\vf{p}$ has a \emph{hyperbolic sector} if a side of $\vf{p}$ is locally as:
    We say that $\vf{p}$ has an \emph{attracting parabolic sector} if a side of $\vf{p}$ is locally as:
    Finally, we say that $\vf{p}$ has a \emph{repelling parabolic sector} if a side of $\vf{p}$ is locally as:
  ...
  \end{proposition}
  \subsection{Quasi-linear partial differential equations}
\end{multicols}
\end{document}