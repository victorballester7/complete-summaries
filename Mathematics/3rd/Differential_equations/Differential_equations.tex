...
\begin{multicols}{2}[\section{Differential equations}]
  ...
  \end{proposition}
  \begin{proposition}
    Let $L\in\RR_{>0}$ and $f:[0,L]\rightarrow\RR$ be a function. Then, the solution to the heat equation $u(x,t)$ with the boundary conditions $u(x,0)=f(x)$ and $u(0,t)=u(L,t)=0$ is: $$u(x,t)=\sum_{n=1}^\infty b_n\sin\left(\frac{\pi n x}{L}\right)\exp{-\frac{n^2\pi^2k}{L^2}t}$$ where $\displaystyle b_n=\frac{1}{L}\int_0^Lf(x)\sin\left(\frac{\pi n x}{L}\right)\dd{x}$.
  \end{proposition}
