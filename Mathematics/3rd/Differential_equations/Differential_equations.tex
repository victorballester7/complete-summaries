...
\begin{multicols}{2}[\section{Differential equations}]
  ...
  \end{lemma}
  \begin{corollary}
    Let $U\subseteq\RR\times\RR^n$ be an open set, $\vectorfunction{f}:U\rightarrow\RR^n$ be a continuous function and $\vectorfunction{\varphi}:(a,b)\rightarrow\RR^n$ be a maximal solution of $\vectorfunction{x}'=\vectorfunction{f}(t,\vectorfunction{x})$. If $b<\infty$, then for all compact set $K\subset U$, $\exists t_k<\infty$ such that $\forall t\in[t_k,b)$, $(t,\vectorfunction{\varphi}(t))\notin K$. In that case, we say that $\vectorfunction{\varphi}$ \textit{tends to the boundary of $U$}.
  \end{corollary}
  ...
  \begin{theorem}
    ...
    \begin{align*}
      \vectorfunction{\xi}_{t_0}:\RR^n & \longrightarrow\mathcal{A}_n                       \\
  ...
  \begin{corollary}
    ...
    \begin{align*}
      ...
      x                               & \longmapsto(\vectorfunction{\xi}_s(x))(t)
    \end{align*}
