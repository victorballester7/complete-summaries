...
\begin{multicols}{2}[\section{Differential equations}]
  ...
  \end{proposition}
  \begin{definition}
    Let $U\subseteq \RR^{2n}$ be an open set, $H:U\rightarrow\RR^{2n}$ be a function and $(\vf{x},\vf{y}):=(x_1,\ldots,x_n,y_1,\ldots,y_n)$. The differential system
    \begin{equation*}
      \left\{
      \begin{aligned}
        {x_1}' & =-\pdv{H}{y_1}(\vf{x}) \\
  ...
  \end{definition}
  \begin{proposition}
    Let $U\subseteq \RR^{2n}$ be an open set, $H:U\rightarrow\RR^{2n}$ be the Hamiltonian of its Hamiltonian system. Then, $H$ is a first integral of that differential system.
  \end{proposition}
\end{multicols}
\end{document}