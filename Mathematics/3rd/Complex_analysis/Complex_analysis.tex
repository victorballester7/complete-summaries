...
\begin{multicols}{2}[\section{Complex analysis}]
  ...
  \end{proposition}
  \begin{definition}
    We define the \emph{extended complex plane} as $\CC_\infty:=\CC\cup\{\infty\}$. We define the \emph{extended real numbers} as $\RR_\infty:=\RR\cup\{\infty\}$. The topologies added to those sets are the ones given by the one-point compactification\footnote{See \mcref{TOP:alex}.}.
  \end{definition}
  ...
  \end{theorem}
  \begin{corollary}
    Let $U\subseteq \CC$ be an open set, $u,v:U\rightarrow\CC$ be functions such that their partial derivatives exist, they are continuous and they satisfy \mcref{CA:cauchyrieamann}. Then, $f=u+\ii v$ is holomorphic on $U$.
  \end{corollary}
  \begin{definition}
  ...
  \end{proposition}
  \begin{proposition}
    Let $U\subseteq \CC$ be an open set, $z_0\in U$ and $f:U\rightarrow \CC$ be a $\CC$-differentiable function at $z_0$. Then, the Cauchy-Riemann equations of \mcref{CA:cauchyrieamann} can also be written as: $$\overline{\partial} f(z_0)=0$$
  \end{proposition}
  \begin{proposition}
  ...
  \begin{definition}
    Let $\gamma_1:[a,b]\rightarrow\CC$, $\gamma_2:[c,d]\rightarrow\CC$ be two curves\footnote{Recall \mcref{DG:curves}.} of class $\mathcal{C}^1$ such that $\gamma_1(t_1)=\gamma_2(t_2)=z_0\in\CC$ for some $t_1\in[a,b]$ and $t_2\in[c,d]$. Suppose that ${\gamma_1}'(t_1),{\gamma_2}'(t_2)\ne 0$. We define the angle between $\gamma_1$ and $\gamma_2$ at $z_0$ as $$\arg{\gamma_1}'(t_1)-\arg{\gamma_2}'(t_2)$$ which does not depend on the determination of the argument.
  \end{definition}
  \begin{definition}
  ...
  \begin{proposition}
    ...
    \begin{itemize}
      \item If the parametrization is positive\footnote{Recall \mcref{DG:reparam}.}, then: $$\int_{\gamma_1}f(z)\dd{z}=\int_{\gamma_2}f(z)\dd{z}$$
  ...
  \end{corollary}
  \begin{theorem}[Analytic continuation theorem]
  ...
  \begin{definition}
    Let $U\subseteq \CC\cong\RR^2$ be an open set and $u:U\rightarrow \RR$ be a function of class $\mathcal{C}^2$. We say that $u$ is \emph{harmonic} if $\laplacian u(z)=0$ $\forall z\in U$\footnote{Recall \mcref{FSV:laplacian}.}.
  \end{definition}
  \begin{proposition}
  ...
  \end{proposition}
  \begin{proposition}[Calculation of integrals]
  ...
  \begin{theorem}
    ...
    \end{gather*}
  \end{theorem}
  \begin{theorem}[Casorati-Weierstra\ss\  theorem]
