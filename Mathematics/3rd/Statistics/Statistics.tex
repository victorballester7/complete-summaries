...
\begin{multicols}{2}[\section{Statistics}]
  ...
  \begin{theorem}
    ...
    where $z_{1-\frac{\alpha}{2}}$ denote the $1-\frac{\alpha}{2}$ quantile of the standard normal distribution (see \mcref{STA:quantile}).
  \end{theorem}
  ...
  \end{definition}
  \begin{definition}[Quantile]\label{STA:quantile}
