...
\begin{multicols}{2}[\section{Statistics}]
  ...
  \begin{definition}[Neymann-Pearson test]
    ...
    \begin{gather*}
      \left\{\vf{x}\in\mathcal{X}:\frac{L(\theta_1;\vf{x})}{L(\theta_0;\vf{x})}< C\right\}= A_0\\
      \left\{\vf{x}\in\mathcal{X}:\frac{L(\theta_1;\vf{x})}{L(\theta_0;\vf{x})}\geq C\right\}= A_1
    \end{gather*}
