...
\begin{multicols}{2}[\section{Real and functional analysis}]
  ...
  \begin{definition}
    ...
    \begin{align*}
      \mathcal{L}^p(E) & :=\left\{\vf{f}:E\rightarrow \RR^n\text{ measurable}:\int_E\abs{\vf{f}}^p<\infty\right\}                                                                                    \\
      \begin{split}
        \mathcal{L}^\infty(E) &:=\left\{\vf{f}:E\rightarrow \RR^n\text{ measurable}:\exists M>0\text{ with }\right.\\&\hspace{4.5cm}\left.\abs{\vf{f}(x)}\almoste{\leq} M, x\in E\right\}
      \end{split} \\
      \mathcal{N}(E)   & :=\{\vf{f}:E\rightarrow \RR^n\text{ measurable}:\vf{f}\almoste{=} 0\}
    \end{align*}
  \end{definition}
  \begin{definition}
  ...
  \begin{definition}
    ...
    \begin{align*}
      ...
      C_{\textrm{c}}(U) & =\{f:U\rightarrow\RR:f\in\mathcal{C}^0(U),\supp f\text{ is compact}\}
    \end{align*}
  \end{definition}
  \begin{theorem}
    ...
    \begin{enumerate}
      ...
      \item $C_{\textrm{c}}(U)$ is dense in $L^p(U)$.
    \end{enumerate}
  \end{theorem}
