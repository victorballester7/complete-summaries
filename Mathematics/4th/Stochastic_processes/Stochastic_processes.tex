...
\begin{multicols}{2}[\section{Stochastic processes}]
  ...
  \begin{lemma}
    Let $X$ be a CTMC with transition matrix $\vf{P}(t)$. Then, $(p_{ij}(t))$ are continuous functions for all $i,j\in I$.
  \end{lemma}
  \begin{proof}
  ...
  \end{proof}
  \begin{theorem}
    Let $X$ be a CTMC with transition matrix $\vf{P}(t)$. Then, for any $i,j\in I$, the following limits exist:
    $$
      \begin{cases}
