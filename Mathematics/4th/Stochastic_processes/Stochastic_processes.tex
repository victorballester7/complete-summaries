...
\begin{multicols}{2}[\section{Stochastic processes}]
  ...
  \begin{definition}
    A \emph{Markov chain} is a sequence of random variables discrete random variables $(X_n)$ with support $I$, the state space, such that:
    \begin{multline*}
  ...
  \end{proposition}
  \begin{proof}
    The first statement is a consequence of the conditional probability being a probability. The second statement is clear.
  \end{proof}
  \begin{lemma}
