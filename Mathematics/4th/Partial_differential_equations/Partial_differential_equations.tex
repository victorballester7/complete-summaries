...
\begin{multicols}{2}[\section{Partial differential equations}]
  ...
  \end{proposition}
  \subsection{First order partial differential equation}
  ...
  \begin{proposition}[Method of characteristics]
    ...
    Note that we can write this equation as: $$\begin{pmatrix}
      ...
      \end{pmatrix}\cdot\begin{pmatrix}
        ...
        -1
      \end{pmatrix}=0$$
    And so the solutions of \cref{PDE_char} are the integral curves (called \emph{characteristic curves}) that form the surface of the graph $u(x,t)$. This are given by:
    \begin{equation*}
      \left\{
      \begin{aligned}
        \dv{x}{\tau} & = a(x,t,u) \\
    ...
    \end{equation*}
  \end{proposition}
  \begin{proposition}[Traffic equation]
