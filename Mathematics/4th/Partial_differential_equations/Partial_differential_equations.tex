...
\begin{multicols}{2}[\section{Partial differential equations}]
  ...
  \end{proposition}
  \begin{theorem}
    Let $u_0,v_0:\RR\rightarrow\RR$ and $f:\RR^2\rightarrow\RR$ be functions. The solution $u(x,t)$ to the wave equation with driven force $f$ and initial conditions $u(x,0)=u_0(x)$ and $u_t(x,0)=v_0(x)$ is:
    \begin{multline*}
