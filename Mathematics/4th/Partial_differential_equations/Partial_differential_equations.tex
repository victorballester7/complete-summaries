...
\begin{multicols}{2}[\section{Partial differential equations}]
  ...
  \begin{proposition}
    ...
    $$
    is a distribution. Hence, $\Lambda_f(\varphi)$ is usually denoted by $\dotp{f}{\varphi}$. Sometimes we will do an abuse of notation denoting $\Lambda_f$ as $f$ (by the \mnameref{PDE:postfundamentallemma}).
  \end{proposition}
  \begin{proof}
