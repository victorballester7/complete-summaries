...
\begin{multicols}{2}[\section{Dynamical systems}]
  ...
  \begin{definition}
    A \emph{local bifurcation} on a differential systems $\vf{x}'=\vf{f}(\vf{x},\vf\mu)$ is the study of the changes in the local stability properties of equilibrium points, periodic orbits or other invariant sets as the parameter $\vf\mu$ cross through critical thresholds.
  \end{definition}
  \begin{definition}
  ...
  \begin{center}
    ...
    \end{minipage}
    \captionof{figure}{Principal kinds of bifurcation}
