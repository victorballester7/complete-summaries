...
\begin{multicols}{2}[\section{Dynamical systems}]
  ...
  \begin{definition}[Saddle-node bifurcation]
    ...
    \cref{DS_sn-trans-fork--bif} shows the qualitative behavior of that system\footnote{In these images, the red lies means that the point $(\mu,x)$ is repelling. The blue lines means that the point $(\mu,x)$ is attracting.}.
  \end{definition}
  ...
  \end{theorem}
  \begin{theorem}[Semi-hyperbolic singular points classification theorem]
  ...
  \end{definition}
  \begin{theorem}[Nilpotent singular points classification theorem]
    Consider the differential system
    $$
      \left\{
      \begin{aligned}
