...
\begin{multicols}{2}[\section{Linear algebra}]
  ...
  \begin{definition}
    ...
    The set of invertible matrices of size $n$ over $\RR$ is denoted by $\GL_n(\RR)$\footnote{Or more generally, the set of invertible matrices of size $n$ over a field (see \mcref{AS:field}) $K$ is denoted by $\GL_n(K)$.}.
  \end{definition}
  \begin{lemma}
  ...
  \begin{definition}
    A \emph{vector space} over a field\footnote{See \mcref{AS:field}.} $K$ is a set $V$ together with two operations
    \begin{align*}
  ...
  \end{corollary}
  \begin{proposition}\label{LA:multiplicities}
  ...
  \end{definition}
  \begin{proposition}\label{LA:jordan}
    ...
    \begin{enumerate}
      \item\label{LA:diag1} For $i=1,\ldots,k$, the sum of the sizes of Jordan blocks associated with the eigenvalue $\lambda_i$ is $n_i$.
      \item\label{LA:diag2} The sizes of Jordan blocks are determined by $\dim(\ker((f-\lambda_i\id)^r))$, $r=1,\ldots,n_i-1$.
    \end{enumerate}
  \end{proposition}
  \begin{proposition}
    ...
    $$\vf{J}:=\vf{P}^{-1}\vf{A}\vf{P}=
      ...
      \end{pmatrix}
    $$
    where $\vf{J}_1,\ldots,\vf{J}_r$ are Jordan blocks associated with eigenvalues $\lambda_1,\ldots,\lambda_k$ satisfying \mcref{LA:diag1,LA:diag2} of \mcref{LA:jordan}. In that case, we say that $\vf{J}$ is the \emph{Jordan form} of $\vf{A}$.
  \end{proposition}
  \begin{theorem}
  ...
  \end{proposition}
  \begin{definition}\label{LA:perpendicular}
    ...
    $$\function{\pi}{U_1\perp U_2}{U_i}{\vf{u}_1+\vf{u}_2}{\vf{u}_i}$$
    for $i=1,2$ is called \emph{orthogonal projection} of $V$ onto $U_i$ according to the decomposition $V=U_1\perp U_2$.
  \end{definition}
  \begin{proposition}[Gram-Schmidt process]\label{LA:Gram-Schmidt}
