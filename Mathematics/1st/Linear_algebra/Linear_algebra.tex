...
\begin{multicols}{2}[\section{Linear algebra}]
  ...
  \end{corollary}
  \begin{prop}
    Let $\vf{A}\in\mathcal{M}_n(\RR)$. Then: $$\det \vf{A}=\sum_{\sigma\in S_n}\varepsilon(\sigma)\prod_{i=1}^na_{i\sigma(i)}$$
  \end{prop}
  \begin{prop}
  ...
  \begin{definition}
    ...
    \begin{align*}
      ...
      (\vf{v}_1,\vf{v}_2) & \longmapsto \vf{v}_1+ \vf{v}_2 & (\lambda,\vf{v}) & \longmapsto \lambda\cdot \vf{v}
    \end{align*}
  ...
  \begin{definition}
    ...
    \begin{align*}
      V        & \longrightarrow V^*           \\
      \vf{v}_0 & \longmapsto\varphi_{\vf{v}_0}
  ...
  \begin{definition}\label{LA_perpendicular}
    ...
    \begin{align*}
      ...
      \vf{v}=\vf{u}_1+\vf{u}_2 & \longmapsto \vf{u}_i
    \end{align*}
  ...
  \begin{prop}
    ...
    \begin{align*}
      ...
      \vf{v}              & \longmapsto\|\vf{v}\|_\varphi=\sqrt{\varphi(\vf{v},\vf{v})}
    \end{align*}
