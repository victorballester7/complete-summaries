...
\end{lemma}
\begin{lemma}
    Let $p\in\RR[x]$ be a polynomial defined on an interval $[a,b]$ such that $\deg p\leq n$ and let $\{x_i\}_{i=0}^n\subseteq[a,b]$ be a set of nodes. Then, $$I(p)=\int_a^bp(x)dx\iff I(x^k)=\int_a^bx^kdx,\text{ for }k=0,1,\ldots,n.$$
\end{lemma}
