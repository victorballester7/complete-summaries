...
\end{definition}
\begin{prop}
    Lagrange's interpolation problem has a unique solution and this is: $$p_n(x)=\sum_{k=0}^ny_kL_k(x).$$
\end{prop}
...
\end{prop}
\begin{prop}
    Let $f:[a,b]\rightarrow\RR$ be a function of class $\mathcal{C}^n$ and $\{x_i\}_{i=0}^n\subset\mathbb{R}$ be points. We define $f[x_i,\overset{n+1}{\cdots},x_i]$ as $$f[x_i,\overset{n+1}{\cdots},x_i]=\frac{f^{(n)}(x_i)}{n!}.$$
\end{prop}
\begin{theorem}
