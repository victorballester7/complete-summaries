...
\begin{multicols}{2}[\section{Mathematical analysis}]
  ...
  \end{corollary}
  \begin{corollary}\label{MA:derivk_powerseries}
  ...
  \end{definition}
  \begin{lemma}
    Let $f:\RR \rightarrow\RR $ be a continuous function with compact support. Let $(\phi_\varepsilon)$ be an approximation of unity. Then, $(f*\phi_\varepsilon)$ converges uniformly to $f$ on $\RR $ as $\varepsilon\rightarrow 0$.
  \end{lemma}
  ...
  \end{theorem}
  \begin{corollary}[Stirling's formula]\label{MA:stirling}
