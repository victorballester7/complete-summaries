...
\begin{tikzpicture}
    ...
    \node[color=orange] at (-8,3) {\LARGE $\{0\}$}; %R
    \node[color=orange] at (-8,2) {\LARGE $\displaystyle\quot{\mathbb{Z}}{n\mathbb{Z}}$}; %R
    \node[color=orange] at (-8,1) {\LARGE $\mathcal{M}_n(R)$}; %R
    \node[color=orange] at (-8,0) {\LARGE $\mathbb{Z}[\sqrt{d}]$}; %>=ID
    ...
    \node[color=orange] at (-7,-6) {\LARGE $\mathbb{Q}(\sqrt{d})$}; %F
