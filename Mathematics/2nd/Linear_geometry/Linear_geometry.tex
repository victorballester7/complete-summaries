...
\begin{itemize}
    \item It's the configuration described in figure \ref{fan}.\par
    \begin{minipage}{\linewidth}
        \centering
...
\begin{itemize}
    \item It's the configuration described in figure \ref{pap}.\par
    \begin{minipage}{\linewidth}
        \centering
...
\begin{itemize}
    \item It's the configuration described in figure \ref{des}.\par
    \begin{minipage}{\linewidth} 
        \centering
