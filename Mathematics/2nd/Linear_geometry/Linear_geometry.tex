...
\begin{itemize}
    ...
    \begin{minipage}{\linewidth} 
        \centering
        \includegraphics[width=0.6\linewidth]{Images/klein.tex} 
    ...
    \begin{minipage}{\linewidth} 
        \centering
        \includegraphics[width=0.6\linewidth]{Images/disk.tex} 
    ...
    \begin{minipage}{\linewidth} 
        \centering
        \includegraphics[width=0.6\linewidth]{Images/half.tex} 
...
\begin{itemize}
    ...
    \begin{minipage}{\linewidth}
        \centering
        \includegraphics[width=0.6\linewidth]{Images/fano.tex} 
...
\begin{itemize}
    ...
    \begin{minipage}{\linewidth}
        \centering
        \includegraphics[width=0.6\linewidth]{Images/pappus.tex} 
...
\begin{itemize}
    ...
    \begin{minipage}{\linewidth} 
        \centering
        \includegraphics[width=0.75\linewidth]{Images/desargues.tex} 
