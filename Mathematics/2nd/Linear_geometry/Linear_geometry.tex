...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \illustration{0.6}{Images/klein}{Beltrami–Klein model}{} hsdhaksdañsdsdsd
    \end{itemize}
    % \begin{center}
    ...
    % \end{center}
    \illustration{0.6}{Images/disk}{Poincare disk model}{}
    ...
    \end{itemize}
    \illustration{0.6}{Images/half}{Poincare half-plane model}{}
\end{itemize}
\end{definition}
...
\begin{itemize}
    ...
    \illustration{0.6}{Images/fano}{Fano configuration}{fan}
...
\begin{itemize}
    ...
    \illustration{0.6}{Images/pappus}{Pappus configuration}{pap}
...
\begin{itemize}
    ...
    \illustration{0.75}{Images/desargues}{Desargues configuration}{des}
