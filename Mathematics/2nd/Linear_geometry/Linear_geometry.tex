...
\begin{multicols}{2}[\section{Linear geometry}]
  ...
  \begin{definition}
    ...
    \end{itemize}
  \end{definition}
  \begin{axiom}[Incidence axioms]\label{LG:incidence}
    \hfill
    \begin{enumerate}
    ...
    \end{enumerate}
  \end{axiom}
  \begin{axiom}[Order axioms]\label{LG:order}
    \hfill
    \begin{enumerate}
  ...
  \end{definition}
  \begin{axiom}[Congruence axioms]\label{LG:congruence}
    \hfill
    \begin{enumerate}
  ...
  \begin{definition}
    ...
    \begin{itemize}
      \item A \emph{Hilbert plane} is a geometry where \mcref{LG:incidence,LG:order,LG:congruence} are satisfied.
  ...
  \begin{definition}
    \emph{Absolute geometry} is the part of Euclidean geometry that only uses \mcref{LG:incidence,LG:order,LG:congruence}.
  \end{definition}
  \begin{theorem}
    ...
    \begin{itemize}
      \item Beltrami-Klein model:
            \begin{itemize}
              ...
              \item Two segments $AB,A'B'\in\mathcal{K}$ are congruent if and only if there is an Euclidean motion\footnote{See \mcref{LG:euclidean_motion}.} $f$ such that $f(A)=A'$ and $f(B)=B'$. Two angles $hk,h'k'\in\mathcal{K}$ are congruent if and only if there is an Euclidean motion $f$ such that $f(h)=h'$ and $f(k)=k'$.
            \end{itemize}
            \begin{center}
  ...
  \end{definition}
  \begin{definition}\label{LG:pproj}
  ...
  \end{definition}
  \begin{theorem}
    $X$ is a projective space of dimension 2 if and only if $X$ satisfies the axioms of \mcref{LG:pproj}.
  \end{theorem}
  ...
  \begin{definition}
    ...
    \begin{itemize}
      \item It's the configuration described in \mcref{LG:fan}.
            \begin{center}
              \begin{minipage}{\linewidth}
                \centering
  ...
  \begin{definition}
    ...
    \begin{itemize}
      \item It's the configuration described in \mcref{LG:pap}.
            \begin{center}
              \begin{minipage}{\linewidth}
                \centering
  ...
  \begin{definition}
    ...
    \begin{itemize}
      \item It's the configuration described in \mcref{LG:des}.
            \begin{center}
              \begin{minipage}{\linewidth}
                \centering
  ...
  \begin{definition}
    An \emph{Euclidean affine space} is an affine space such that the associated vector space is an Euclidean vector space\footnote{Remember \mcref{LA:espai-euclidia}.}.
  \end{definition}
  \begin{definition}
  ...
  \end{proposition}
  \begin{definition}
    Two subvarieties $L_1=P_1+F_1$, $L_2=P_2+F_2$ of an Euclidean affine space $\mathbb{A}$ are \emph{orthogonal}, $L_1\perp L_2$, if $F_1\perp F_2$\footnote{Remember \mcref{LA:perpendicular}.}.
  \end{definition}
  \begin{definition}
  ...
  \end{definition}
  \begin{proposition}
    Let $\mathbb{A}$ be an Euclidean affine space. $f:\mathbb{A}\rightarrow\mathbb{A}$ is an Euclidean motion if and only if $f$ is an affinity and $\dd{f}$ is an isometry\footnote{Remember \mcref{LA:isometry}. From this we deduce that if $\vf{A}\in\mathcal{M}_n(K)$ is the matrix associated with an isometry, then $\vf{A}\transpose{\vf{A}}=\vf{I}_n$.}.
  \end{proposition}
  ...
  \begin{definition}
    We say a bilinear form is \emph{anisotropic} or \emph{elliptic} if the unique isotropic vector\footnote{Recall \mcref{LA:isotrop}.} is the null vector.
  \end{definition}
  \begin{theorem}
    There is, expect for equivalence, only one symmetric bilinear form of dimension 2 such that it is non-singular\footnote{Recall \mcref{LA:singular}.} and non-elliptic. We call this bilinear form \emph{hyperbolic plane}.
  \end{theorem}
  \begin{definition}
