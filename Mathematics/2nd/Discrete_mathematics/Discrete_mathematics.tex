...
\begin{multicols}{2}[\section{Discrete mathematics}]
  ...
  \begin{center}
    \begin{minipage}{\linewidth}
      \centering
      \includestandalone[mode=image|tex,width=0.3\linewidth]{Images/graph}
      \captionof{figure}{A graph of order 3 and size 5}
    \end{minipage}
  \end{center}
  \begin{definition}
  ...
  \begin{center}
    \begin{minipage}{\linewidth}
      \centering
      \includestandalone[mode=image|tex,width=0.3\linewidth]{Images/complete5}
      \captionof{figure}{$K_5$}
    \end{minipage}
  \end{center}
  \begin{definition}
  ...
  \begin{center}
    \begin{minipage}{\linewidth}
      \centering
      \includestandalone[mode=image|tex,width=0.3\linewidth]{Images/bipartite}
      \captionof{figure}{Bipartite graph}
    \end{minipage}
  \end{center}
  \begin{definition}
  ...
  \begin{center}
    \begin{minipage}{\linewidth}
      \centering
      \includestandalone[mode=image|tex,width=0.6\linewidth]{Images/tree}
