...
\begin{multicols}{2}[\section{Electromagnetism}]
  ...
  \begin{prop}[Continuous charge distribution]
    Consider a continuous charge distribution of density $\rho$. Then $$W=\frac{1}{2}\int_\mathcal{V}\rho\phi \dd \mathcal{V}=\frac{\varepsilon_0}{2}\int_{\mathbb{R}^3}E^2\dd \mathcal{V}.$$
  \end{prop}
  \begin{definition}
