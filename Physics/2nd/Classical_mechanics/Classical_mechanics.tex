...
\begin{multicols}{2}[\section{Classical mechanics}]
    ...
    \begin{prop}[Rocket without gravity]
        In this situation we have $\boldsymbol{F}^\text{ext}=0$ and we will suppose $\boldsymbol{v}=v\boldsymbol{j}$, $\boldsymbol{c}=-c\boldsymbol{j}$. Finally we get
        \begin{equation}
    ...
    \begin{prop}[Unit vectors]
        Remember we have $$\boldsymbol{e}_r=\boldsymbol{i}\cos\theta+\boldsymbol{j}\sin\theta,\quad\boldsymbol{e}_\theta=-\boldsymbol{i}\sin\theta+\boldsymbol{j}\cos\theta.$$ Therefore we obtain,
        \begin{equation}
