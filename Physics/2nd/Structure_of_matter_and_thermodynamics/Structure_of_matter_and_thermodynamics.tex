...
\begin{multicols}{2}[\section{Structure of matter and thermodynamics}]
  ...
  \begin{definition}[Schrödinger equation]
    ...
    $$\frac{-\hbar^2}{2m}\laplacian\Psi(\mathblack{r},t)+U(\mathblack{r},t)\Psi(\mathblack{r},t)=\ii\hbar\pdv{\Psi(\mathblack{r},t)}{t}$$ where $\mathblack{r}=x\mathblack{i}+y\mathblack{j}+z\mathblack{k}$.
  \end{definition}
