...
\begin{multicols}{2}
    ...
    \begin{law}[Fourier's law]
        ...
        $$\grad\vf{\Phi}_q=-\lambda\grad T$$ where $\vf{\Phi}_q$ is the heat flux density (energy transferred per unit of surface and time) and $\lambda$ is the material's \textit{thermal conductivity} ($[\lambda]=\text{W}\cdot\text{m}^{-1}\cdot\text{K}^{-1}$).
    \end{law}
