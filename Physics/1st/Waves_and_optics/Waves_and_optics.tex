...
\begin{multicols}{2}[\section{Waves and optics}]
  ...
  %                 $$\frac{\omega_1}{\omega_2}=\frac{a}{b}\in\QQ$$ D'aquesta manera combinant les dues equacions d'ona podem crear corbes com les que es mostren a la \mcref{liss}.
  %         \end{itemize}
  %         \begin{minipage}{\linewidth}
  %           \centering
  ...
  % \end{minipage}
  % Ones de xoc:
  % Angle ($\theta$) i nombre de Mach ($M$): $$\sin\theta=\frac{v}{u}\qquad M=\frac{u}{v}$$ {\footnotesize on s'ha emprat la notació de la \mcref{xoc}.}\newline
  % \begin{minipage}{\linewidth}
  %   \centering
  ...
  % {\footnotesize on s'ha emprat la notació de la \mcref{plano}.}\newline
  % \begin{minipage}{\linewidth}
  ...
  % \end{minipage}
  % Prisma òptic: \newline
  % En desviació mínima: $$\varepsilon_1'=\varepsilon_2=\frac{\alpha}{2}\qquad\varepsilon_1=\varepsilon_2'$$ {\footnotesize on s'ha emprat la notació de la \mcref{pris}.}\newline
  % \begin{minipage}{\linewidth}
  ...
  % Tipus de lents:
  % \begin{itemize}
  %   \item Convergents: {\footnotesize vegeu la \mcref{conv}.}
  %   \item Divergents:\newline
  %         \begin{minipage}{\linewidth}
  %           \centering
