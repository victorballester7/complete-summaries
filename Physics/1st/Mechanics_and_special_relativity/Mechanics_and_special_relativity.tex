...
\begin{minipage}{\linewidth}
    ...
    \captionof{figure}{Con del passat i del futur.}
\end{minipage}
...
\begin{minipage}{\linewidth}
    ...
    \captionof{figure}{Cas general d'efecte Doppler relativista.}
\end{minipage}
...
\begin{minipage}{\linewidth}
    ...
    \captionof{figure}{Efecte Compton. Normalment la par\-tí\-cu\-la de massa sol ser un electró.}
\end{minipage}
\subsection{Fluids}
\begin{definition}
...
\begin{minipage}{\linewidth}
    ...
    \captionof{figure}{Força de viscositat.}
\end{minipage}
...
\begin{minipage}{\linewidth}
    ...
    \captionof{figure}{Velocitat en un fluid amb viscositat $\eta$.}
\end{minipage}
