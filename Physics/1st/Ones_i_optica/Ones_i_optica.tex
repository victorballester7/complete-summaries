...
\begin{itemize}
    ...
    \begin{figure}
       \centering
       \includegraphics[width=3cm]{Physics/1st/Ones_i_optica/Imatges/tors.jpg}
    \end{figure}
    \item Pèndol físic:
    \begin{gather*}
    ...
    \begin{figure}
       \centering
       \includegraphics[width=3cm]{Physics/1st/Ones_i_optica/Imatges/fisic.jpg}
    \end{figure}
\end{itemize}
...
\begin{itemize}
    ...
    \begin{figure}
       \centering
       \includegraphics[width=5cm]{Physics/1st/Ones_i_optica/Imatges/beat.jpg}
       \caption{Batiment. Aquí, $T_p=\frac{2\pi}{\omega_p}$ és el període de l'ona modulada i $T_m=\frac{2\pi}{\omega_m}$ és el període de l'ona moduladora. Com veiem a la figura: $T_m>T_p$.}
       \label{beat}
    \end{figure}
    Intensitat:
    \begin{multline*}
...
\begin{itemize}
    ...
    \begin{figure}
        \includegraphics[width=5cm]{Physics/1st/Ones_i_optica/Imatges/pol1.jpg} 
        \caption{Polarització per absorció. El polaritzador deixa passar el camp elèctric en una sola direcció i l'analitzador rota aquesta direcció un angle $\theta$.}
    \end{figure}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=4cm]{Physics/1st/Ones_i_optica/Imatges/dif.jpg} 
        \caption{Polarització per birrefringència.}
        \label{bir}
    \end{figure}
\end{itemize}
...
\begin{itemize}
    ...
    \begin{figure}[ht]
        ...
        \caption{Hipermetropia.}   
    \end{figure}\hspace{0.15cm}
    \begin{figure}[ht]
        \includegraphics[width=\linewidth]{Physics/1st/Ones_i_optica/Imatges/hip1.jpg} 
        \caption{Hipermetropia corregida amb una lent convergent.}
    \end{figure}
    \item Miopia:\newline
    \begin{figure}[ht]
        \includegraphics[width=\linewidth]{Physics/1st/Ones_i_optica/Imatges/mio.jpg} 
        \caption{Miopia.}   
    \end{figure}\hspace{0.15cm}
    \begin{figure}[ht]
        \includegraphics[width=\linewidth]{Physics/1st/Ones_i_optica/Imatges/mio1.jpg} 
...
Si estem a prop de la incidència normal, els dos feixos se superposen amb una diferència de fase $\delta$: $$\delta=\frac{2\pi}{\lambda}2nd+\pi$$ {\footnotesize on el primer terme correspon al canvi de fase per la diferència de camins i el segon terme al canvi de fase per a la reflexió interna.}
        ...
        \begin{figure}[ht]
           \centering \includegraphics[width=\linewidth]{Physics/1st/Ones_i_optica/Imatges/newton.jpg} 
            \caption{Anells de Newton. Ara el desfasament depèn del radi. És per això que observem un patró circular d'interferències.}
        \end{figure}
        \item Franges de Fizeau:\newline
        \begin{figure}[ht]
            \includegraphics[width=\linewidth]{Physics/1st/Ones_i_optica/Imatges/fizeau.jpg} 
            \caption{}
        \end{figure}
...
$$\delta=\frac{2\pi}{\lambda}d\sin\theta+\pi$$
    ...
    \end{itemize}
        ...
        Intensitat: $$I(\theta)=4I_0\frac{\sin^2\beta}{\beta^2}\cos^2(\delta/2)$$ {\footnotesize on $\beta=\frac{2\pi}{\lambda}\frac{a}{2}\sin\theta$ i $\frac{\delta}{2}=\frac{2\pi}{\lambda}\frac{d}{2}\sin\theta$.}\newline      \begin{figure}[ht]
            \includegraphics[width=\linewidth]{Physics/1st/Ones_i_optica/Imatges/dif2.jpg} 
            \caption{Gràfic d'intensitat en funció de $\sin\theta$ de la difracció de dues escletxes. Observem que la difracció d'una escletxa modula el $\cos^2(\delta/2)$ que re\-pre\-sen\-ta la interferència entre dues ones.}
        \end{figure}
